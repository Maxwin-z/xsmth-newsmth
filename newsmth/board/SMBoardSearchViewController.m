...
//               @(CellTypeHasReply)
    ...
    [_textFields enumerateObjectsUsingBlock:^(id obj, NSUInteger idx, BOOL *stop) {
        ...
        if (textField != self.textFieldForDate) {
...
- (void)doSearch
{
    NSString *url = [NSString stringWithFormat:URL_PROTOCOL @"//www.mysmth.net/bbsbfind.php?q=1&board=%@&title=%@&title2=%@&title3=%@&userid=%@&dt=%@&ag=%@&og=%@",
