...
- (void)removeAtIndex:(NSInteger)index
{
    if (index < _currentIndex) {    // already uploaded
        ...
        NSString *deleteUrl = [NSString stringWithFormat:URL_PROTOCOL @"//www.mysmth.net/bbsupload.php?act=delete&attachname=%@", data.key];
...
- (void)next
{
    ...
    dispatch_async(_queue, ^{
        ...
        ASIFormDataRequest *request = [[ASIFormDataRequest alloc] initWithURL:[NSURL URLWithString:URL_PROTOCOL @"//www.mysmth.net/bbsupload.php?act=add"]];
